...
if len(sys.argv) == 3:
    ...
    ext_1 = os.path.splitext(sys.argv[2])

    if ext_1[1].lower() == ext_2[1].lower() and ext_1[1] in extenstions:
        try:
        ...
        sys.exit("Input and output have diffent extensions")
    elif ext_2[1] not in extensions:
        sys.exit("Invalid output")


    print(ext_1, type(ext_1))
elif len(sys.argv) <3:
